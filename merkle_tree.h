...
class merkleTree {
    ...
    public:
        ...
        void clearTree();                                     //deletes the root from tree
        void clearTree(Node* node);                           //deletes node from tree
        void rebuildTree();                                   //rebuilds tree with overwritten data value
        void rebuildTree(vector<int> data);                   //rebuilds tree with new data vector
